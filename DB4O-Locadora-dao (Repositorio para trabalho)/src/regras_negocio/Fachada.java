...
public class Fachada {
	...
	public static List<Jogo> listarJogos(String data) throws Exception {
		...
		if(resultado == null) {
			throw new Exception("Não existe jogo nesta data: "+data);
		}
		//System.out.println(resultado);
		//retorna todos os ingressos 
		return resultado;
	...
	public static Jogo	localizarJogo(int id) throws Exception {
		...
		if(j == null) {
			throw new Exception("Jogo com id: " + id + " não existe!!!");
		}
	...
	public static void 	apagarJogo(int id) throws Exception{
		...
		Jogo jogo = daojogo.read(id);
		if(jogo == null) {
			throw new Exception ("Não existe nenhum jogo com este id: " + id);
		}
	...
	public static void	apagarIngresso(int codigo) throws Exception {
		...
		if(ingresso == null) {
			throw new Exception("Codigo: " + codigo+ " de ingresso não existe no banco");
		}
		...
		public static void	apagarTime(String nome) throws Exception {
			...
			if(t == null) {
				throw new Exception ("Time: " + nome + " não foi criado!!!");
			}
			
			//Um time não poderá ser excluído se possuir jogos
			if(t.getjogos().size() != 0) {
				throw new Exception ("Time: " + nome + " não pode ser excluido, pois possui jogos");
			}
		...
		//Jogos que não possuem ingressos
		...
		public static Ingresso localizarIngresso(int codigo) throws Exception {
			...
			if(i == null) {
				throw new Exception ("Id: "+ codigo  + " não existe!!!");
			}
			return i;
		}
		...
		public static List<Time> localizarorigem(String origem) throws Exception {
			...
			if(i.size() == 0) {
				throw new Exception ("Origem: " + "'" + origem + "'" + " não existe no banco!!!");
			}
			return i;
		}
		...
		public static List<Jogo> jogosdotime (String nome) throws Exception{
			...
			Time T = time.get(0);
			if(T.getjogos().size() == 0) {
				throw new Exception ("Time: " + nome + " não tem jogos cadastrados");
			}
