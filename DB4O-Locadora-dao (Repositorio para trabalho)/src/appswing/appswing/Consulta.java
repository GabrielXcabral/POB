...
public class Consulta {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(index<0)
					...
					case 1: 
						...
						break;
					case 2: 
						String letra = JOptionPane.showInputDialog("Digite a sigla do pa�s do time");
						String origem = letra;
						try {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Nomes de times em ordem alfabetica", "Jogos que n�o possuem ingressos vendidos", "Time que que tem a mesma origem", "Consulta um ingresso especifico dentro do banco", "listar todos os jogos do time"}));
